...
const CompilingWeekStats = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        await StatisticsRequests.getCompilingStatisticsForLastWeek()
            .then(value => {
                console.log(value.data)
                setData(value.data.map(value => value.compilations));
...
export default CompilingWeekStats;